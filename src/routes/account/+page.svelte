...
<div class="w-full min-h-screen relative" onmousemove={handleMouseMove} role="presentation">
  ...
  <div class="relative z-10 max-w-4xl mx-auto p-4 md:p-8">
    ...
    <div class="bg-white/2 bg-linear-to-br from-white/5 to-transparent backdrop-blur-2xl border border-white/10 rounded-3xl overflow-hidden shadow-[0_8px_32px_0_rgba(0,0,0,0.5)] relative">
        ...
        {:else}
          <div class="space-y-8 mt-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div class="flex items-start space-x-4"><div class="w-10 h-10 rounded-full bg-gray-800/80 border border-gray-700 flex items-center justify-center shrink-0"><Mail class="w-5 h-5 text-gray-400" /></div><div><p class="text-sm text-gray-500 uppercase tracking-wider">Email</p><p class="text-white font-medium">{formData.email || 'Not provided'}</p></div></div>
              <div class="flex items-start space-x-4"><div class="w-10 h-10 rounded-full bg-gray-800/80 border border-gray-700 flex items-center justify-center shrink-0"><Phone class="w-5 h-5 text-gray-400" /></div><div><p class="text-sm text-gray-500 uppercase tracking-wider">Phone</p><p class="text-white font-medium">{formData.phone || 'Not provided'}</p></div></div>
              <div class="flex items-start space-x-4 md:col-span-2">
                <div class="w-10 h-10 rounded-full bg-gray-800/80 border border-gray-700 flex items-center justify-center shrink-0 mt-1"><MapPin class="w-5 h-5 text-gray-400" /></div>
                <div class="w-full">
